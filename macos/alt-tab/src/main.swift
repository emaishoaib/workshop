...
// (removed: CliClient.detectCommand()/sendCommandAndProcessResponse(...) — the CLI protocol
// was deleted along with CliEvents.swift; see App.swift for the fuller explanation.)
