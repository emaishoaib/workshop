...
class TileView: FlippedView {
    ...
    /// Used to also highlight search-matched substrings in the title/app-icon (search-in-switcher
    /// was deleted, so the query is now always empty — this always takes the "no query" path).
