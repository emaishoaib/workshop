...
class BackgroundWork {
    ...
    static func preStart() {
        ...
        // (removed: permissionsSystemCallsQueue — it existed to serialize the old
        // SCShareableContent/CGDisplayStream-based screen-recording probes, which were replaced
        // by a synchronous CGPreflightScreenCaptureAccess call; see SystemPermissions.swift)
